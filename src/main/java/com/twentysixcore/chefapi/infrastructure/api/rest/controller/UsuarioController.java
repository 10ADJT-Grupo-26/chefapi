...
public class UsuarioController {
    ...
    public UsuarioController(CadastrarUsuarioUseCase cadastrar, BuscarUsuarioPorIdUseCase buscar, DeletarUsuarioPorId deletar, UsuarioApiMapper mapper, ProcurarUsuarioUseCase procurar ) {
    ...
    @GetMapping("/procurar")
    public ResponseEntity<List<UsuarioOutput>> listar(@RequestParam(required = false) String parametrobusca) {
        List<UsuarioOutput> listaUsuarios = procurar.executar(parametrobusca).getBody();
